package ganjiang.moye.com.locomotive.utils;
...
/**
 * Created by lovezh on 2017/12/25.
...
public class RetrofitClients {
    ...
    //服务端根路径
    public static String baseUrl = "http://my.damatouzi.com/";
    ...
    public static RetrofitClients getInstance(String url) {

        return new RetrofitClients(url);
    }

    public static RetrofitClients getInstance(String url, Map<String, String> headers) {
        return new RetrofitClients(url, headers);
    }
    ...
    private RetrofitClients(String url) {
        this(url, null);
    }

    private RetrofitClients(String url, Map<String, String> headers) {
